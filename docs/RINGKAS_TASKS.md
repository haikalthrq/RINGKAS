...
| Task ID | Target Commit Date | Priority | Area | Task | Dependencies | Expected Output | Acceptance Criteria | Risk | Status |
|---|---:|---|---|---|---|---|---|---|---|
| T-0414 | 2026-07-16 | P0 | Docs/Config | Lock Cloudflare Workers AI embedding architecture and configuration contract | T-0402, T-0403 | Source-of-truth docs and env examples define Cloudflare embedding, optional same-model secondary/tertiary account failover, separate generation variables, versioned collection contract, no different-model/provider fallback, live dimension verification requirement, and migration boundary | All source-of-truth docs are consistent; no vector dimension is invented; placeholders only; no application code, collection, or production data is changed | Documentation drift or accidental mixing of generation and embedding configuration | done |
...
| T-0502 | 2026-07-01 | P0 | Generation | Add Cloudflare Workers AI generation client | T-0501 | Generation client configured | Used in the locked generation order | Provider behavior hidden | done |
...
| T-0509 | 2026-07-04 | P1 | Frontend | Connect chat UI to backend | T-0207, T-0504 | User can ask question from UI | Answer displays citations | UX hides limitations | done |
| T-0510 | 2026-07-04 | P1 | Frontend | Connect document search UI to backend | T-0208, T-0411 | Search results displayed | Metadata visible | Search not useful | done |
| T-0511 | 2026-07-04 | P1 | Frontend | Connect admin ingestion UI to backend | T-0209, T-0507, T-0508 | Admin can trigger and view job status | Role guard enforced | Admin UI scope creep | done |
