...
13. Jika sumber tidak cukup, sistem menjawab parsial dengan limitation atau menolak substantif.
...
13. Multi-agent workflow di end-user application.
14. Fine-tuning LLM.
15. Training embedding model sendiri.
16. Mengganti ASP.NET backend utama dengan FastAPI/Node/Django.
17. Mengganti Qdrant dengan vector DB lain.
18. Mengganti PostgreSQL dengan database utama lain.
