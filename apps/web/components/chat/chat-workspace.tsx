...
const copy = {
  id: {
    ...
    emptyDescription: "Tanyakan statistik dari publikasi BPS yang terindeks. Jawaban substantif selalu membutuhkan bukti sumber.",
    suggestions: [
    ...
    ready: "Siap membantu",
    searching: "Mencari publikasi BPS dan memeriksa buktinya...",
    sufficient: "Bukti cukup",
    partial: "Bukti sebagian",
    insufficient: "Bukti belum cukup",
    statusUnavailable: "Status evidence tidak tersedia",
    sources: "Sumber dan citation",
    closestSources: "Sumber terdekat",
    sourceCount: (count: number) => `${count} sumber`,
    noSources: "Tidak ada citation yang bisa ditampilkan untuk jawaban ini.",
    unverified: "Belum ada jawaban terverifikasi karena sumber citation tidak tersedia.",
    noAnswer: "Jawaban tidak tersedia.",
    limitationPartial: "Bukti yang tersedia hanya mendukung sebagian jawaban. Periksa kutipan sebelum menggunakannya.",
    limitationInsufficient: "Bukti yang tersedia belum cukup untuk menjawab secara substantif. Sumber di bawah hanya kecocokan terdekat.",
    errorEmpty: "Tulis pertanyaan sebelum mengirim.",
    errorDefault: "Chat belum tersedia. Periksa koneksi lalu coba lagi.",
    errorRate: "Batas penggunaan tercapai sementara. Coba lagi nanti.",
    errorAuth: "Sesi berakhir. Masuk kembali untuk melanjutkan.",
    errorServer: "Layanan sedang mengalami kendala. Pertanyaan kamu tetap tersimpan di kotak input.",
    retryQuestion: "Coba kirim ulang pertanyaan",
    sourcesOpen: (count: number) => `Buka ${count} citation`,
    sourceDetail: "Detail sumber",
    closeSource: "Tutup detail sumber",
    openCitation: (index: number) => `Buka citation ${index}`,
    document: "Dokumen",
    region: "Wilayah",
    page: "Halaman",
    sourcePublication: "Buka publikasi sumber",
    sourceUnavailable: "Link publikasi tidak tersedia.",
    language: "Bahasa",
  ...
  en: {
    ...
    emptyDescription: "Ask about indexed BPS publications. Substantive answers always need source evidence.",
    suggestions: [
    ...
    ready: "Ready to help",
    searching: "Searching BPS publications and checking the evidence...",
    ...
    unverified: "No verified answer is available because citation evidence was not returned.",
    noAnswer: "No answer was returned.",
    limitationPartial: "The available evidence only supports part of this answer. Verify the cited passages before relying on it.",
    limitationInsufficient: "The available evidence is not sufficient for a substantive answer. Sources below are closest matches only.",
    errorEmpty: "Write a question before sending it.",
    errorDefault: "Chat is unavailable. Check your connection and try again.",
    errorRate: "The usage limit was reached temporarily. Try again later.",
    errorAuth: "Your session ended. Sign in again to continue.",
    errorServer: "The service is having trouble. Your question remains in the composer.",
